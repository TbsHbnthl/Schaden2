...
\begin{itemize}
	\item Bewertung von Rückstellungen f\"ur Sch\"aden, Pr\"amien, Regulierungskosten und Regresse
...
\begin{itemize}
	...
	\begin{itemize} 
		...
		\item als Basis der VmF zur Erfüllung ihrer Pflichten
	\end{itemize}
...
\chapter{Versicherungstechnische R\"uckstellungen in der Rechnungslegung}
...
\begin{itemize}
	\item HGB: Grundsätze ordnungsgem\"a{\ss}er Buchf\"uhrung
	\item SII:
	\begin{itemize}
		\item Vollständigkeit, Richtigkeit und Angemessenheit gefordert
...
\begin{itemize}
	\item Basis sind die erwarteten Zahlungsströme
	\item Diskontierung
	...
	\item LRC (Liability for remaining coverage) für bound but not incepted onerous contracts wird eine Drohverlustr\"uckstellung (Loss Component) gebildet, f\"ur incepted contracts eine CSM
\end{itemize}
...
\subsection{Schwankungsr\"uckstellungen unter HGB}
	\begin{itemize}
		...
		\item Granularit\"at: Ermittlung und Bildung f\"ur jeden Versicherungszweig separat
		\item Voraussetzungen (3 Bedingungen m\"ussen erf\"ullt sein):
		\begin{itemize}
			\item Bagatellklausel: Versicherungszweig im Durchschnitt der letzten 3 Jahre mehr als 125.000 EUR verdiente Beitr\"age
			\item Erheblichkeitsklausel: Standardabweichung der Schadenquote im Beobachtungszeitraum (i.d.R. 15 Jahre) betr\"agt mindestens 5 \%-Punkte
			\item Finanzierungsbedarfsklausel: Im Beobachtungszeitraum \"uberschreitet die kombinierte Schaden- und Kostenquote mindestens einmal 100\%
		\end{itemize}
...
\section{Bewertungsmodell unter SII}
...
\begin{itemize}
	...
	\item BE einer vers.techn. R\"uckstellung $\hat{=}$ wahrscheinlichkeitsgewichteter Durchschnitt zuk\"unftiger Zahlungensstr\"ome unter Ber\"ucksichtigung des Zeitwerts des Geldes (Barwert) und unter Verwendung einer risikofreien Zinskurve (existiert brutto und netto, netto ist abz\"uglich RV und einforderbare Betr\"age von Zweckgesellschaften) 
	\item Proportionalit\"atsprinzip: unter SII verankert, unternehmensindividuelle Situation betrachten
\end{itemize}

\section{Schadenr\"uckstellungen unter SII}
...
\begin{itemize}
	...
	\item BE einer Schadenr\"uckstellung $\hat{=}$ diskontierter wahrscheinlichkeitsgewichteter Durchschnitt künftiger Sch\"aden, die sich vor dem Bilanzstichtag ereignet haben
	\item Zuk\"unftige Zahlungsstr\"ome der SRK (IBNR der SRK) sind Teil der Schadenr\"uckstellungen
	\item Direkte SRK: einzelnen Sch\"aden zuzuordnen (Anwaltskosten, Gutachterkosten)
	\item Indirekte SRK: allgemeine Kosten (Geh\"alter, Geb\"audekosten
\end{itemize}

\section{Pr\"amienr\"uckstellungen unter SII}
...
\section{R\"uckversicherung unter SII}
...
\section{Risikomarge unter SII}
\begin{itemize}
	\item stellt sicher, dass der Wert der vers.techn. R\"uckstellungen dem Betrag entspricht, den VU fordern fordern w\"urden, um die Versicherungsverpflichtungen \"ubernehmen und erf\"ullen zu können
...
\chapter{Grundlagen der aktuariellen Schadenreservebewertung}

\section{Grundlagen und Bezeichnungen}

\subsection{Abwicklungsdreieck bzw. -rechteck}
...
\begin{itemize}
	...
	\item Kernproblem: Bestimmung einer Sch\"ätzung $\hat{R}_i$ f\"ur $R_i$ bzw. $E(R_i)$
	\item Anfalljahre unabhängig voneinander (problematisch, da Inflation z.B. kein Anfalljahreseffekt ist)
...
\section{Sich \"andernde Rahmenbedingungen - Inflation}
...
\subsection{externe Rahnenbedingungen}
...
\section{Raten\"anderungen, Pr\"amienzyklen und Reservezyklen}
...
\section{Die Behandlung von Ausrei{\ss}ern, Gro{\ss}- und Kumulsch\"aden}
...
\section{Abwicklungsmuster und Methoden der Reservebewertung}
...
\section{Behandlung Nachlauf und Gl\"attung}
...
\subsection{Sch\"atzung der Tailfaktoren}
\begin{itemize}
...
\subsubsection{Praxisaspekte bei der Sch\"atzung von Tailfaktoren}
\begin{itemize}
	\item Verwendung nur eines Tailfaktors ist unhandlich, wenn Zahlungsstr\"ome erzeugt werden m\"ussen
	\item Auswahl von $\phi$ und $K$ mithilfe von Grafiken
	\item Alternative: Abwicklungsmuster aus Benchmarkportfolios verwenden
\end{itemize}

\chapter{Stochastische Modelle der aktuariellen Schadenreservebewertung}
...
\begin{itemize}
	...
	\item Aggregation der Prognosen und Prognosefehler über mehrere Segmente unter Ber\"ucksichtigung von Korrelationen
...
\section{Das Incremental-Loss-Ratio-Modell}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Bilder/ILR.png}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Bilder/ILR2.png}
\end{figure}

\section{Das CL-Modell}

Bemerkung: $Var(X)=E(Var(X|Y)) + Var(E(X|Y))$

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Bilder/CL.png}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Bilder/CL2.png}
\end{figure}


\section{\"Uberpr\"ufung der Modellannahmen und Modellauswahl}
...
\subsection{Graphische Residuenanalyse}
\begin{itemize}
...
\subsection{Auswahl eines Modells}
\begin{itemize}
...
\section{Aggregation der Reserven mehrerer Segmente}
...
\subsection{Korrelationsmodell zur Aggregation von Reserven nach Braun 2004}
...
\subsection{Bemerkungen zum Korrelationsmodell}
...
\section{Bornhuetter/Ferguson-Modell}
...
\subsection{Eigenschaften B/F-Methode}
\begin{itemize}
...
\subsection{Modell Annahmen nach Mack}
...
\subsection{Annahmen des MCL-Modells}

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Bilder/MCLAnnahmen.png}
\end{figure}
